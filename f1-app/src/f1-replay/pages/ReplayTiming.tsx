...
export default function ReplayPage() {
  ...
  // Read data from the downloaded JSON
  const sessionData = replay.sessionData;
  const trackData = replay.trackData;
  const lapsResponse = replay.lapsData;
  const sessionLoading = replay.loading;
  const sessionError = replay.error;
  const trackLoading = replay.loading;
  const trackError = replay.error;
